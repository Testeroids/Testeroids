...
namespace Testeroids
{
    ...
    public interface IMock
    {
        ...
        /// 			of the mock <see cref="IMock.Object"/> property, at which
        ...
        /// 			has already been generated by accessing the <see cref="IMock.Object"/> property.
        /// 		</exception><exception cref="T:System.ArgumentException">The <typeparamref name="TInterface"/> specified
        /// 			is not an interface.
        /// 		</exception>
        /// <example>
        ...
        /// 			the mock is used, a <see cref="IMock.VerifyAll"/> call is issued on the mock
        ...
        where T : class
    {
        ...
        /// 		</typeparam><param name="property">Property expression to stub.</param>
        /// <example>
        ...
        /// <typeparam name="TProperty">Type of the property, inferred from the property
        /// 			expression (does not need to be specified).
        /// 		</typeparam><param name="property">Property expression to stub.</param><param name="initialValue">Initial value for the property.</param>
        /// <example>
        /// If you have an interface with an int property <c>Value</c>, you might
        /// 			stub it using the following straightforward call:
        /// 
